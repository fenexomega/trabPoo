...
public class Atendente extends JFrame {
	...
	public Atendente() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Atendente.class.getResource("/Images/logo-01.png")));
		...
		button_3.setIcon(new ImageIcon(Atendente.class.getResource("/Images/nova_consulta-01.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Atendente.class.getResource("/Images/cadastrar_medico-01.png")));
		btnNewButton.setBounds(492, 61, 107, 109);
		panel.add(btnNewButton);
		
		JButton button_2 = new JButton("");
		button_2.setBackground(SystemColor.desktop);
		button_2.setIcon(new ImageIcon(Atendente.class.getResource("/Images/sair-01.png")));
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CriarPacienteGUI pacGUI = new CriarPacienteGUI();
				pacGUI.show();
				pacGUI.setModal(true);
			}
		});
		button_1.setBackground(SystemColor.desktop);
		button_1.setIcon(new ImageIcon(Atendente.class.getResource("/Images/cadastrar_paciente.png")));
		...
		button.setIcon(new ImageIcon(Atendente.class.getResource("/Images/pesquisa-01.png")));
		button.setBounds(526, 230, 40, 27);
		panel.add(button);
		
		JLabel lblJlabel = new JLabel("");
		lblJlabel.setIcon(new ImageIcon(Atendente.class.getResource("/Images/logo-01.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Atendente.class.getResource("/Images/inicial_background.png")));
		...
		button_4.setIcon(new ImageIcon(Atendente.class.getResource("/Images/seach-01.png")));
